...
internal class TestNode : Node(NoPointer) {
    ...
    override fun listBalances() =
        BalanceDetails(
            ...
            0uL,
            0uL,
            channels.sumOf { it.outboundCapacityMsat / 1000uL },
            emptyList(),
            emptyList(),
        )
}
...
internal fun channel(
    ...
    ChannelDetails(
        ...
        config = ChannelConfig(0u, 0u, 0u, MaxDustHtlcExposure.FixedLimit(0uL), 0uL, false),
        channelShutdownState = null,
    )
