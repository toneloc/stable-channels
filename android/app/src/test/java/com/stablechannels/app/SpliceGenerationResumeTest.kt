 ...
 * already actively monitoring that same txid (foreground grace-period reconnect, or startup racing
 * a replayed SpliceNegotiated). Bumping in that case strands the counter one step ahead of the
 * value the still-running monitor captured — since the monitor is never re-armed for a
