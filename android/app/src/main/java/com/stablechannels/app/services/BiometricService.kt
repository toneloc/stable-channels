...
object BiometricService {
    ...
    /**
     * Detects the available biometric type on the device. Returns FINGERPRINT, FACE, IRIS, or NONE.
     */
    fun getAvailableBiometricType(context: Context): BiometricType {
        ...
        return when {
            ...
            pm.hasSystemFeature("android.hardware.biometrics.iris") -> BiometricType.IRIS
                ...
                BiometricType
                    .FINGERPRINT // Default to fingerprint if enrolled but feature not declared
        }
    }
     ...
     *
     * Uses suspendCancellableCoroutine to wrap the callback-based BiometricPrompt API. When
     * [allowDeviceCredential] is true, sets BIOMETRIC_STRONG | DEVICE_CREDENTIAL as allowed
     * authenticators, enabling auto-fallback to device credential on lockout.
     */
    suspend fun authenticate(
        ...
        when (canAuthResult) {
            ...
            BiometricManager.BIOMETRIC_ERROR_NONE_ENROLLED -> return AuthResult.NOT_ENROLLED
        }
            ...
            val callback =
                object : BiometricPrompt.AuthenticationCallback() {
                    ...
                    override fun onAuthenticationFailed() {
                        ...
                        // BiometricPrompt handles retry internally; we only act on final
                        // error/success.
    ...
    private fun mapErrorToResult(errorCode: Int, allowDeviceCredential: Boolean): AuthResult {
        return when (errorCode) {
            ...
            BiometricPrompt.ERROR_NO_BIOMETRICS -> AuthResult.NOT_ENROLLED

            BiometricPrompt.ERROR_HW_NOT_PRESENT,
            BiometricPrompt.ERROR_HW_UNAVAILABLE,
            BiometricPrompt.ERROR_NO_DEVICE_CREDENTIAL -> AuthResult.NOT_AVAILABLE

            else -> AuthResult.BIOMETRY_FAILED
        }
    }
}
