...
<b>Stable Channels</b> lets Lightning Network node runners keep one side of their channel balances stable in dollar terms, for example $100. 
...
These two nodes query price feeds every 5 minutes. Then, based on the new price, they update their channel balance with their counterparty to keep the Stable Receiver stable at $100 of bitcoin. 
